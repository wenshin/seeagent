module.exports = [{
  ...
  parsed: {
    os: { family: 'iOS', major: '9', minor: '2', patch: '1' },
    device: { family: 'iPhone', major: '0', minor: '0', patch: '0', type: 'phone' },
    app: { family: 'Mobile Safari UIWebView', vendor: 'Wechat', major: '6', minor: '3', patch: '9' }
  }
}, {
  ...
  parsed: {
    os: { family: 'iOS', major: '9', minor: '2', patch: '1' },
    device: { family: 'iPhone', major: '0', minor: '0', patch: '0', type: 'phone' },
    app: { family: 'Chrome Mobile iOS', major: '48', minor: '0', patch: '2564' }
  }
}, {
  ...
  parsed: {
    os: { family: 'iOS', major: '9', minor: '2', patch: '1' },
    device: { family: 'iPhone', major: '0', minor: '0', patch: '0', type: 'phone' },
    app: { family: 'Mobile Safari UIWebView', vendor: 'Meituan', major: '0', minor: '0', patch: '0' }
  }
}, {
  ...
  parsed: {
    os: { family: 'iOS', major: '9', minor: '2', patch: '1' },
    device: { family: 'iPhone', major: '0', minor: '0', patch: '0', type: 'phone' },
    app: { family: 'Mobile Safari UIWebView', vendor: 'Maoyan', major: '6', minor: '5', patch: '0' }
  }
}, {
  ...
  parsed: {
    ...
    app: { family: 'Chrome Mobile', vendor: 'Maoyan', major: '5', minor: '9', patch: '1' }
  }
}, {
  ...
  parsed: {
    os: { family: 'Mac OS X', major: '10', minor: '11', patch: '3' },
    device: { family: 'Other', major: '0', minor: '0', patch: '0', type: 'desktop' },
    app: { family: 'Chrome', vendor: 'Daxiang', major: '1', minor: '0', patch: '0' }
  }
}, {
  ...
  parsed: {
    ...
    device: { family: 'iPhone', major: '0', minor: '0', patch: '0', type: 'phone' },
    app: { family: 'Mobile Safari UIWebView', vendor: 'Daxiang', major: '3', minor: '1', patch: '1' }
  }
}, {
  ...
  parsed: {
    ...
    device: { family: 'iPhone', major: '0', minor: '0', patch: '0', type: 'phone' },
    app: { family: 'Mobile Safari UIWebView', vendor: 'Taobao', major: '5', minor: '3', patch: '3' }
  }
}, {
  ...
  parsed: {
    ...
    app: { family: 'Mobile Safari UIWebView', vendor: 'Weibo', major: '5', minor: '5', patch: '0' }
  }
}, {
  ...
  parsed: {
    ...
    app: { family: 'Chrome Mobile', vendor: 'Weibo', major: '5', minor: '4', patch: '0' }
  }
}, {
  ...
  parsed: {
    ...
    app: { family: 'Chrome Mobile', major: '42', minor: '0', patch: '2307' }
  }
}, {
